...
export default function HomePage() {
  ...
  return (
    <>
      {/* First thing you see: the castle IS the navigation. Pinned, full-screen;
          scrolling (or clicking the central keep) dives into the Great Hall. */}
      <CastleHub variant="hero" />

      {/* The Great Hall — the hero, now a section reached by diving the castle. */}
      <div className="container space-y-20 py-16">
        <section
          id="great-hall"
          aria-labelledby="great-hall-heading"
        ...
        >
          ...
          <p className="mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-foreground-muted">
            A graduating Computer Engineer building production AI. This portfolio is
            itself the proof: an AI{" "}
            <strong className="text-foreground">Sorting Hat</strong> answers questions
            about my work using retrieval-augmented generation — grounded only in my
            resume and project write-ups.
          </p>
        ...
        <section className="rounded-card border border-border bg-surface p-6 sm:p-10">
          ...
          <p className="mt-3 max-w-2xl text-foreground-muted">
            ...
            → vector search → a grounded LLM answer with citations, protected by caching
            and rate-limiting. A &ldquo;Behind the Magic&rdquo; panel will show the live
