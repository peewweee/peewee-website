...
export default function HomePage() {
  ...
  return (
    <div className="container space-y-20 py-12 sm:py-16">
      {/* Hero / Great Hall greeting */}
      <section className="max-w-3xl">
        <p className="font-mono text-xs uppercase tracking-[0.2em] text-accent-text">
          Welcome to the Great Hall
        </p>
        <h1 className="mt-4 text-balance font-display text-4xl font-bold leading-tight text-foreground sm:text-6xl">
          {siteConfig.name}
        </h1>
      ...
      {/* The castle navigation (Phase 2 mounts 3D here; 2D fallback for now) */}
      <CastleHub />
