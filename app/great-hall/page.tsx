...
export default function GreatHallPage() {
  return (
    <div className="container space-y-20 py-12 sm:py-16">
      {/* The Great Hall — the welcome / intro. Two columns from lg up: the
          introduction on the left, the enchanted portrait on the right. */}
      <section
        aria-labelledby="great-hall-heading"
        className="grid items-center gap-10 lg:grid-cols-[2fr_1fr] lg:gap-14"
      >
        <div>
        ...
        {/* Stacks below the buttons on mobile (capped so it never dominates). */}
        <PortraitFrame
          src="/my-picture/image.jpg"
          alt="Portrait of Phoebe Rhone Gangoso."
          priority
